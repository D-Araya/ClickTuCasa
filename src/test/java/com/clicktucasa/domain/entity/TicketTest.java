...
class TicketTest {
    ...
    void shouldCreateTicketWithAvailableStatus() {
        ...
        TicketPrice price = new TicketPrice(new BigDecimal("25.00"));
    ...
    void shouldCreateTicketWithSpecifiedStatus() {
        ...
        TicketPrice price = new TicketPrice(new BigDecimal("50.00"));
    ...
    void shouldDefaultToAvailableStatusWhenPassedNullStatus() {
        // ARRANGE & ACT
        Ticket ticket = new Ticket(103L, new TicketPrice(new BigDecimal("10.00")), null);
    ...
    void shouldThrowExceptionWhenTicketNumberIsInvalid() {
        // ARRANGE
        TicketPrice price = new TicketPrice(new BigDecimal("10.00"));

        // ACT & ASSERT
        assertThrows(IllegalArgumentException.class, () -> new Ticket(null, price));
        assertThrows(IllegalArgumentException.class, () -> new Ticket(0L, price));
        assertThrows(IllegalArgumentException.class, () -> new Ticket(-5L, price));
    }

    @Test
    @DisplayName("Should throw IllegalArgumentException when ticket price is null")
    void shouldThrowExceptionWhenTicketPriceIsNull() {
        // ARRANGE & ACT & ASSERT
        assertThrows(IllegalArgumentException.class, () -> new Ticket(100L, null));
    }
    ...
    void shouldReserveTicketSuccessfully() {
        // ARRANGE
        Ticket ticket = new Ticket(201L, new TicketPrice(new BigDecimal("15.00")));
    ...
    void shouldThrowExceptionWhenReserveParametersAreInvalid() {
        // ARRANGE
        Ticket ticket = new Ticket(202L, new TicketPrice(new BigDecimal("15.00")));
    ...
    void shouldThrowExceptionWhenReservingNonAvailableTicket() {
        // ARRANGE
        Ticket ticket = new Ticket(203L, new TicketPrice(new BigDecimal("15.00")), TicketStatus.SOLD);
    ...
    void shouldCheckIfReservationIsExpired() {
        // ARRANGE
        Ticket ticket = new Ticket(204L, new TicketPrice(new BigDecimal("15.00")));
        LocalDateTime now = LocalDateTime.of(2026, 7, 26, 10, 0);
    ...
    void shouldReturnFalseForExpirationWhenNotReserved() {
        // ARRANGE
        Ticket ticket = new Ticket(205L, new TicketPrice(new BigDecimal("15.00")));
    ...
    void shouldReturnFalseForExpirationWhenReservedUntilIsNull() {
        // ARRANGE
        Ticket ticket = new Ticket(300L, new TicketPrice(new BigDecimal("15.00")), TicketStatus.RESERVED);
    ...
    void shouldReleaseReservation() {
        // ARRANGE
        Ticket ticket = new Ticket(206L, new TicketPrice(new BigDecimal("15.00")));
    ...
    void shouldDoNothingWhenReleasingNonReservedTicket() {
        // ARRANGE
        Ticket ticket = new Ticket(207L, new TicketPrice(new BigDecimal("15.00")), TicketStatus.SOLD);
    ...
    void shouldAssignTicketToOwnerSuccessfully() {
        // ARRANGE
        Ticket ticket = new Ticket(208L, new TicketPrice(new BigDecimal("15.00")));
    ...
    void shouldThrowExceptionWhenAssignToOwnerWithEmptyId() {
        // ARRANGE
        Ticket ticket = new Ticket(209L, new TicketPrice(new BigDecimal("15.00")));
    ...
    void shouldThrowExceptionWhenAssigningAlreadySoldTicket() {
        // ARRANGE
        Ticket ticket = new Ticket(210L, new TicketPrice(new BigDecimal("15.00")));
